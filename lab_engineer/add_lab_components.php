...
//}
?>
Electronic components<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="panel-body tab-content">
                                        <div class="tab-pane active" id="tab-first">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Component_ name </label>
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name = "name" placeholder = "Component name" value=""/>                                                    
                                                </div>
                                            </div>
											
											<div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">component_group </label>
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
											...
											<div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">container_ number </label>
                                                <div class="col-md-6 col-xs-12">                                                                                                                                                        
