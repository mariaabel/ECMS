        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">lab_exercise</li>
                </ul>
                <!-- END BREADCRUMB -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">List of All lab_exercise</h3>
									<div class="btn-group pull-right">
                                        <p>
                                        <a href="add_lab_exercise.php"><button type="button" class="btn btn-info"><span class = "fa fa-plus-circle"></span> add new lab_exercise</button></a> 
                                        </p>
                                    </div>
                                </div>
