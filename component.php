                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel-body tab-content">
                                        <div class="tab-pane active" id="tab-first">
                                            ...
                                            <div class="form-group">
                                            <label class="col-md-3 control-label">lab_components </label>
                                            <div class="col-md-6">                                                                                
                                                <select name = "lab_component" class="form-control select" data-live-search="true">
                                                    <option value = ""></option>
                                                    <option value = "id">Resistors</option>
                                                    <option value = ""></option>
                                                    <option value = "id">Capacitors</option>
                                                     
                                                    <option value = ""></option>
                                                    <option value = "id">Inductors</option>
                                                     
                                                    <option value = ""></option>
                                                    <option value = "id">ICs</option>
                                                     
                                                    <option value = ""></option>
                                                    <option value = "id">Regulators and Microprocessors</option>
                                                </select>
                                            </div>
                                        </div>   
                                    </div>
                                     <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">date_requested *</label>
                                            <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name = "title" placeholder = "date_requested *" value=""/>  
                                    </div>
                                    </div>
                                     <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">date_returned *</label>
                                             <div class="col-md-6 col-xs-12">                                                                                                                                                        
                                                    <input type="text" class="form-control" name = "title" placeholder = "date_returned *" value=""/>  
                                    </div>
                                </div>
                                    <div class="form-group">
